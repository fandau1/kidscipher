import { KidscipherGlyphs } from "../../../fonts/KidscipherGlyphs.js";
import SubstitutionCipher from "../../substitution/SubstitutionCipher";
import { POLAND_CROSS_CONFIG_MAP } from "./PolandCrossConfig";


class PolandCrossCipher extends SubstitutionCipher {
    static POLAND_CROSS_CONFIG_MAP = POLAND_CROSS_CONFIG_MAP;
